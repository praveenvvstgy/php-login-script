...
<tr><td>Username:</td><td><input readonly type="text" name="user" maxlength="30" value="<?php echo "Admin"; ?>"></td><td><?php echo $form->error("user"); ?></td></tr>
<tr><td>Password:</td><td><input readonly type="password" name="pass" maxlength="30" value="<?php echo "vvstgy"; ?>"></td><td><?php echo $form->error("pass"); ?></td></tr>
